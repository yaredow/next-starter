    ...
    <div className="container py-12 md:py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mb-16">
          <h1 className="mb-6 font-bold text-3xl tracking-tight sm:text-4xl md:text-5xl">
            About Us
          </h1>
        ...
        <section className="mb-16">
          <h2 className="mb-6 font-bold text-2xl">Our Values</h2>
          <div className="grid gap-6 md:grid-cols-2">
            {/* Value 1 */}
            <div className="rounded-lg border p-6">
              <h3 className="mb-2 font-medium text-lg">Customer Focus</h3>
            ...
            {/* Value 2 */}
            <div className="rounded-lg border p-6">
              <h3 className="mb-2 font-medium text-lg">Innovation</h3>
              <p className="text-muted-foreground">
            ...
            {/* Value 3 */}
            <div className="rounded-lg border p-6">
              <h3 className="mb-2 font-medium text-lg">Transparency</h3>
              <p className="text-muted-foreground">
            ...
            {/* Value 4 */}
            <div className="rounded-lg border p-6">
              <h3 className="mb-2 font-medium text-lg">Quality</h3>
              <p className="text-muted-foreground">
        ...
        <section className="mb-16">
          <h2 className="mb-6 font-bold text-2xl">Our Team</h2>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <h3 className="font-medium text-lg">Team Member Name</h3>
